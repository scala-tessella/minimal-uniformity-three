# the distinct-letter window at six orbits — producing-run record

Record of the orbit-bounded walk behind the paper's distinct-letter window theorem, at six vertex
orbits over 1–24 and 25–36 chambers, in the valence-2 regime. The walk takes two species-level prunes
...
A *record*, separate from `certs/uclass-k6`, where a fresh run writes its own outputs.
